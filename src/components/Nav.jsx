...
const Nav = () => {
  ...
  return (
    <nav className=" w-full h-20 flex justify-center gap-20">
      <a
        href="#card"
        onClick={() => handleButtonClick("interface")}
        className="relative inline-flex w-56 h-10 overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-1 focus:ring-slate-400 focus:ring-offset-1 focus:ring-offset-slate-50"
      >
